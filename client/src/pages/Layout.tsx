    ...
    <div className='layout'>
        ...
        <header className='p-2 mb-2 flex h-35'>
            <div className='flex items-center me-2'>
                <img id='logo' src='200x200.png' className='border-2 p-1 h-full object-cover'></img>
            </div>
            <div className='w-full'>
                <div className='bg-black flex flex-row'>
                    <img src='800x100.png' className='border-2 p-1 w-full max-h-20 object-cover'></img>
                </div>
                <div className='flex flex-row pt-4 justify-between underline nav_items'>
                    <a href='/'>About $PS</a>
                    <a href='/'>$PZ Archive</a>
        ...
        <div className='flex flex-row'>
            <main id='mainContent' className='lg:basis-5/6 w-full border-1 lg:me-2 p-1 max-lg:mx-auto'>
                <Outlet />
            </main>
